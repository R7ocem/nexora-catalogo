...
CREATE TABLE IF NOT EXISTS catalogo_produtos (
  ...
  replenishment_days INTEGER NOT NULL DEFAULT 7,
  safety_days INTEGER NOT NULL DEFAULT 3,
  auto_calculate_min_stock BOOLEAN NOT NULL DEFAULT true,
...
ADD COLUMN IF NOT EXISTS aviso_imagem_url TEXT,
